...
window.I18N = {
  de:{
    ...
    hero_eyebrow:"Ihr Schweizer Klinker-Fach- und Baustellenbegleiter",
    hero_title:"Klinker mit Charakter —<br>für Wege, Fassaden & Böden.",
    hero_sub:"Ihr Fach- und Baustellenbegleiter für Pflaster- und Mauerklinker aus Ton sowie handgefertigte Tonplatten. Wir beraten, liefern Muster und begleiten Ihr Projekt.",
    ...
    contact_lead:"Persönliche Beratung, Muster und Offerten — direkt vom Fach- und Baustellenbegleiter.",
  ...
  fr:{
    ...
    hero_eyebrow:"Votre accompagnateur technique et de chantier klinker en Suisse",
    hero_title:"Du klinker de caractère —<br>allées, façades & sols.",
    hero_sub:"Votre accompagnateur technique et de chantier pour pavés et briques de parement en terre cuite, ainsi que pour les tomettes faites main. Conseil, échantillons et suivi de votre projet.",
    ...
    contact_lead:"Conseil personnalisé, échantillons et devis — directement de votre accompagnateur technique et de chantier.",
  ...
  it:{
    ...
    hero_eyebrow:"Il vostro accompagnatore tecnico e di cantiere per klinker in Svizzera",
    hero_title:"Klinker di carattere —<br>vialetti, facciate & pavimenti.",
    hero_sub:"Il vostro accompagnatore tecnico e di cantiere per pavimenti e mattoni faccia a vista in cotto, oltre a pianelle fatte a mano. Consulenza, campioni e supporto al progetto.",
    ...
    contact_lead:"Consulenza personalizzata, campioni e preventivi — direttamente dal vostro accompagnatore tecnico e di cantiere.",
  ...
  en:{
    ...
    hero_eyebrow:"Your Swiss clinker specialist & site partner",
    hero_title:"Clinker with character —<br>paths, façades & floors.",
    hero_sub:"Your specialist and on-site partner for clay paving and facing bricks, plus handcrafted clay floor tiles. Advice, samples and support throughout your project.",
    ...
    contact_lead:"Personal advice, samples and quotes — straight from your specialist and site partner.",
