...
window.I18N = {
  de:{
    ...
    hero_title:"Klinker mit Charakter —<br>für Wege, Fassaden & Böden.",
  ...
  fr:{
    ...
    hero_eyebrow:"Votre spécialiste technique et accompagnateur de chantier klinker en Suisse",
    hero_title:"Du klinker de caractère —<br>allées, façades & sols.",
    hero_sub:"Votre spécialiste technique et accompagnateur de chantier pour pavés et briques de parement en terre cuite, ainsi que pour les tomettes faites main. Conseil, échantillons et suivi de votre projet.",
    ...
    contact_lead:"Conseil personnalisé, échantillons et devis — directement de votre spécialiste technique et accompagnateur de chantier.",
  ...
  it:{
    ...
    hero_title:"Klinker di carattere —<br>vialetti, facciate & pavimenti.",
  ...
  en:{
    ...
    hero_title:"Clinker with character —<br>paths, façades & floors.",
