...
window.I18N = {
  de:{
    ...
    hero_cta1:"Kollektion entdecken", hero_cta2:"Beratung anfragen", hero_cta3:"Klinker am Haus ansehen (3D)",
    teaser_eyebrow:"3D-Konfigurator", teaser_title:"Sehen Sie Ihren Klinker am Haus — bevor Sie bestellen.",
    teaser_sub:"Klinker antippen und sofort sehen, wie Fassade und Vorplatz wirken — an fünf Gebäudetypen und im Innenraum.",
    teaser_pick:"Klinker wählen:", teaser_cta:"Jetzt selbst ausprobieren →",
    ...
    nl_btn:"Abonnieren", nl_done:"Danke! Ihre Nachricht wurde gesendet – wir melden uns.",
    // lightbox
  ...
  fr:{
    ...
    hero_eyebrow:"Votre spécialiste technique et suivi de chantier clinker en Suisse",
    hero_title:"Du clinker de caractère —<br>allées, sols & façades.",
    ...
    hero_cta1:"Découvrir la collection", hero_cta2:"Demander conseil", hero_cta3:"Voir la brique sur la maison (3D)",
    teaser_eyebrow:"Configurateur 3D", teaser_title:"Voyez votre clinker sur la maison — avant de commander.",
    teaser_sub:"Touchez une brique et voyez aussitôt l'effet sur la façade et le parvis — sur cinq types de bâtiments et à l'intérieur.",
    teaser_pick:"Choisir la brique :", teaser_cta:"Essayer maintenant →",
    ...
    nl_btn:"S'abonner", nl_done:"Merci ! Votre message a été envoyé – nous vous répondrons.",
  ...
  it:{
    ...
    hero_cta1:"Scopri la collezione", hero_cta2:"Richiedi consulenza", hero_cta3:"Vedi il mattone sulla casa (3D)",
    teaser_eyebrow:"Configuratore 3D", teaser_title:"Guarda il tuo klinker sulla casa — prima di ordinare.",
    teaser_sub:"Tocca un mattone e vedi subito l'effetto su facciata e piazzale — su cinque tipi di edifici e all'interno.",
    teaser_pick:"Scegli il mattone:", teaser_cta:"Prova subito →",
    ...
    nl_btn:"Iscriviti", nl_done:"Grazie! Il messaggio è stato inviato – vi ricontatteremo.",
  ...
  en:{
    ...
    hero_cta1:"Explore the collection", hero_cta2:"Request advice", hero_cta3:"See it on a house (3D)",
    teaser_eyebrow:"3D configurator", teaser_title:"See your clinker on a house — before you order.",
    teaser_sub:"Tap a brick and instantly see how façade and forecourt look — on five building types and indoors.",
    teaser_pick:"Pick a brick:", teaser_cta:"Try it yourself →",
    ...
    nl_btn:"Subscribe", nl_done:"Thank you! Your message has been sent – we'll be in touch.",
...
window.MIX = {
  ...
  view_wall:    {de:"Nahansicht", fr:"Vue rapprochée", it:"Vista ravvicinata", en:"Close-up"},
  ...
  lbl_view:     {de:"Ansicht", fr:"Vue", it:"Vista", en:"View"},
  lbl_surf:     {de:"Fläche", fr:"Surface", it:"Superficie", en:"Surface"},
  ...
  empty:  {de:"Noch nichts ausgewählt. Öffne ein Produkt und füge es hinzu.", fr:"Rien de sélectionné. Ouvrez un produit et ajoutez-le.", it:"Niente selezionato. Apri un prodotto e aggiungilo.", en:"Nothing selected yet. Open a product and add it."},
  ...
  diffcat:{de:"Es lassen sich nur Produkte derselben Kategorie kombinieren.", fr:"Seuls les produits de la même catégorie sont possibles.", it:"Solo prodotti della stessa categoria.", en:"Only products of the same category can be combined."},
  ...
  b_linear:{de:"Lineare Verlegung", fr:"Pose linéaire", it:"Posa lineare", en:"Linear"},
  b_diagonal:{de:"Diagonalverband", fr:"En diagonale", it:"A diagonale", en:"Diagonal"},
  b_block:{de:"Blockverband", fr:"Appareil en bloc", it:"A blocchi", en:"Block bond"},
  ...
  bed:    {de:"Lagerfuge (waagrecht)", fr:"Joint horizontal", it:"Giunto orizzontale", en:"Bed joint (horizontal)"},
  head:   {de:"Stossfuge (senkrecht)", fr:"Joint vertical", it:"Giunto verticale", en:"Head joint (vertical)"},
  ...
  tab_stones:{de:"Steine", fr:"Briques", it:"Pietre", en:"Stones"},
  tab_design:{de:"Gestaltung", fr:"Design", it:"Design", en:"Design"},
  zone_none:{de:"noch leer", fr:"encore vide", it:"ancora vuoto", en:"still empty"},
  stone_one:{de:"Stein", fr:"brique", it:"pietra", en:"stone"},
  stone_many:{de:"Steine", fr:"briques", it:"pietre", en:"stones"},
  pro:{de:"Details für Profis", fr:"Détails pour pros", it:"Dettagli per professionisti", en:"Details for pros"},
  show_all:{de:"Alle Farben", fr:"Toutes les couleurs", it:"Tutti i colori", en:"All colours"},
  show_less:{de:"Weniger", fr:"Réduire", it:"Meno", en:"Fewer"},
  o_mid:{de:"Ausgewogen", fr:"Équilibré", it:"Equilibrato", en:"Balanced"},
  undo:{de:"Rückgängig", fr:"Annuler", it:"Annulla", en:"Undo"},
  cleared:{de:"Auswahl geleert", fr:"Sélection vidée", it:"Selezione svuotata", en:"Selection cleared"},
  intro_q:{de:"Was möchten Sie gestalten?", fr:"Que souhaitez-vous concevoir ?", it:"Cosa vuoi progettare?", en:"What would you like to design?"},
  intro_floor:{de:"Weg & Einfahrt", fr:"Chemin & entrée", it:"Vialetto & accesso", en:"Path & driveway"},
  intro_int:{de:"Innenraum", fr:"Intérieur", it:"Interni", en:"Interior"},
  intro_style:{de:"Wählen Sie einen Stil zum Start — alles bleibt anpassbar", fr:"Choisissez un style pour commencer — tout reste modifiable", it:"Scegli uno stile per iniziare — tutto resta modificabile", en:"Pick a style to start — everything stays adjustable"},
  intro_skip:{de:"Überspringen", fr:"Passer", it:"Salta", en:"Skip"},
