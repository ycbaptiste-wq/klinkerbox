...
window.I18N = {
  de:{
    ...
    hero_eyebrow:"Ihr Schweizer Klinker-Baustellenberater",
    hero_title:"Klinker mit Charakter —<br>für Wege, Fassaden & Böden.",
    hero_sub:"Ihr Baustellenberater für Pflaster- und Mauerklinker aus Ton sowie handgefertigte Tonplatten. Wir beraten, liefern Muster und begleiten Ihr Projekt.",
    ...
    contact_lead:"Persönliche Beratung, Muster und Offerten — direkt vom Baustellenberater.",
  ...
  fr:{
    ...
    hero_eyebrow:"Votre conseiller de chantier klinker en Suisse",
    hero_title:"Du klinker de caractère —<br>allées, façades & sols.",
    hero_sub:"Votre conseiller de chantier pour pavés et briques de parement en terre cuite, ainsi que pour les tomettes faites main. Conseil, échantillons et suivi de votre projet.",
    ...
    contact_lead:"Conseil personnalisé, échantillons et devis — directement de votre conseiller de chantier.",
  ...
  it:{
    ...
    hero_eyebrow:"Il vostro consulente di cantiere per klinker in Svizzera",
    hero_title:"Klinker di carattere —<br>vialetti, facciate & pavimenti.",
    hero_sub:"Il vostro consulente di cantiere per pavimenti e mattoni faccia a vista in cotto, oltre a pianelle fatte a mano. Consulenza, campioni e supporto al progetto.",
    ...
    contact_lead:"Consulenza personalizzata, campioni e preventivi — direttamente dal consulente di cantiere.",
  ...
  en:{
    ...
    hero_eyebrow:"Your Swiss clinker site consultant",
    hero_title:"Clinker with character —<br>paths, façades & floors.",
    hero_sub:"Your site consultant for clay paving and facing bricks, plus handcrafted clay floor tiles. Advice, samples and support throughout your project.",
    ...
    contact_lead:"Personal advice, samples and quotes — straight from your site consultant.",
