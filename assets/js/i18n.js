...
window.I18N = {
  de:{
    ...
    hero_eyebrow:"Ihr Schweizer Klinker-Fachhändler",
    hero_title:"Klinker mit Charakter —<br>für Wege, Fassaden & Böden.",
    hero_sub:"Ihr Fachhändler für Pflaster- und Mauerklinker aus Ton sowie handgefertigte Tonplatten. Wir beraten, liefern Muster und begleiten Ihr Projekt.",
    ...
    catalog_results:"Produkte", catalog_empty:"Keine Produkte für diese Auswahl.",
    ...
    contact_lead:"Persönliche Beratung, Muster und Offerten — direkt vom Fachhändler.",
  ...
  fr:{
    ...
    hero_eyebrow:"Votre revendeur suisse de klinker",
    hero_title:"Du klinker de caractère —<br>allées, façades & sols.",
    hero_sub:"Votre revendeur de pavés et briques de parement en terre cuite, ainsi que de tomettes faites main. Conseil, échantillons et suivi de votre projet.",
    ...
    catalog_results:"produits", catalog_empty:"Aucun produit pour cette sélection.",
    ...
    contact_lead:"Conseil personnalisé, échantillons et devis — directement du revendeur.",
  ...
  it:{
    ...
    hero_eyebrow:"Il vostro rivenditore svizzero di klinker",
    hero_title:"Klinker di carattere —<br>vialetti, facciate & pavimenti.",
    hero_sub:"Il vostro rivenditore di pavimenti e mattoni faccia a vista in cotto, oltre a pianelle fatte a mano. Consulenza, campioni e supporto al progetto.",
    ...
    catalog_results:"prodotti", catalog_empty:"Nessun prodotto per questa selezione.",
    ...
    contact_lead:"Consulenza personalizzata, campioni e preventivi — direttamente dal rivenditore.",
  ...
  en:{
    ...
    hero_eyebrow:"Your Swiss clinker dealer",
    hero_title:"Clinker with character —<br>paths, façades & floors.",
    hero_sub:"Your dealer for clay paving and facing bricks, plus handcrafted clay floor tiles. Advice, samples and support throughout your project.",
    ...
    catalog_results:"products", catalog_empty:"No products for this selection.",
    ...
    contact_lead:"Personal advice, samples and quotes — straight from the dealer.",
